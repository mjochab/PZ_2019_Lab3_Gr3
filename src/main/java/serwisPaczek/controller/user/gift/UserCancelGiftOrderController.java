        ...
        for (GiftOrder giftOrder : listGiftOrders) {
            if (giftOrder.getUser().getId() == getLoggedUser().getId()) {
                giftOrderDtos.add(new GiftOrderDto(giftOrder.getId(),
                        ...
                        giftOrder.getRecipientAdress().getAdress().getName(),
                        giftOrder.getRecipientAdress().getAdress().getSurname(),
                        giftOrder.getRecipientAdress().getAdress().getCity(),
                        giftOrder.getRecipientAdress().getAdress().getStreet(),
                        giftOrder.getRecipientAdress().getAdress().getHouseNumber(),
                        giftOrder.getRecipientAdress().getAdress().getZipCode(),
                        giftOrder.getRecipientAdress().getAdress().getTelephoneNumber(),
                        giftOrder.getRecipientAdress().getAdress().getEmail(),
